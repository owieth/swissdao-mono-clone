...
export class Guild extends Entity {
  ...
  get holders(): MembershipLoader {
    return new MembershipLoader("Guild", this.get("id")!.toString(), "holders");
  }
}
...
export class MembershipLoader extends Entity {
  _entity: string;
  _field: string;
  _id: string;
  ...
  load(): Membership[] {
    ...
    return changetype<Membership[]>(value);
  }
}
