        ...
        <main className="isolate">
            ...
            <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
                ...
                <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
                    <p className="leading-8 text-xl text-gray-600">
            ...
            {/* Team section */}
            <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-48 lg:px-8 py-16 sm:py-16 lg:pb-64">
                <div className="mx-auto max-w-2xl lg:mx-0">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Our Contributors</h2>
                    <p className="mt-6 text-lg leading-8 text-gray-600">
                    Our contributors shine throw effort done for the collective. Everyone is self-driven and shares our vision.
                    </p>
                </div>
                <ul
                    role="list"
