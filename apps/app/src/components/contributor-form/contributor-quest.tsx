            ...
            formObj={{
                blocks: [{
                    name: "welcome-screen", id: "welcome", attributes: {
                        ...
                        attachment: {
                            type: "image", url: "/logos/swissdao_logo.png",
                        },
                        attachmentMaxWidth: "300px",
                    },
                }, {
                    name: "short-text", id: "ethereum_address", attributes: {
                        label: "Ethereum Wallet Address", required: true, placeholder: "0x...",
                    },
                }, {
                ...
                }, ...(principle?.includes("meritocracy") && ensure_people?.includes("experience_points") ? [{
                    name: "statement", id: "won", attributes: {
                    ...
                    name: "number", id: "hours_available", attributes: {
                        required: true, label: "How much time do you have weekly available to contribute to swissDAO?",
                    },
                }, {
                    name: "statement", id: "survey_start", attributes: {
                        label: "Survey",
                    ...
                    name: "statement", id: "survey_title_motivation", attributes: {
                        label: "Motivation and Engagement", buttonText: "Continue", quotationMarks: false,
                    },
                }, {
                    name: 'short-text', id: 'survey_motivation_1', attributes: {
                        label: 'How did you first hear about swissDAO and what motivated you to become a contributor?',
                        required: true,
                    }
                }, {
                    name: 'short-text', id: 'survey_motivation_2', attributes: {
                        label: 'Where were you when you decided to join swissDAO?', required: true,
                    }
                }, {
                    name: 'short-text', id: 'survey_motivation_3', attributes: {
                        label: 'What specific skills or interests do you feel that you bring to the swissDAO community?',
                        required: true,
                    }
                }, {
                    name: 'multiple-choice', id: 'survey_motivation_4', attributes: {
                    ...
                    name: 'statement', id: 'survey_title_project', attributes: {
                        label: 'Project and Vision', buttonText: 'Continue', quotationMarks: false,
                    }
                }, {
                    name: 'short-text', id: 'survey_project_1', attributes: {
                        label: 'Where do you see swissDAO going?', required: true,
                    }
                }, {
                    name: 'multiple-choice', id: 'survey_project_2', attributes: {
                        label: 'Which aspects of swissDAO are most appealing to you?',
                        required: true,
                        verticalAlign: true,
                        choices: [{
                            label: 'Workshops and Education Classes', value: 'Workshops and Education Classes',
                        }, {
                            label: 'Community Building Events', value: 'Community Building Events',
                        }, {
                            label: 'Gaining Practical DAO Experience', value: 'Gaining Practical DAO Experience',
                        }, {
                            label: 'Hackathons', value: 'Hackathons',
                        }, {
                            label: 'Venture Building', value: 'Venture Building',
                        }],
                    }
                }, {
                    name: "statement", id: "survey_title_experience", attributes: {
                        label: "Perception and Experience", buttonText: "Continue", quotationMarks: false,
                    },
                }, {
                    name: 'slider', id: 'survey_experience_1', attributes: {
                    ...
                    name: 'long-text', id: 'survey_experience_2', attributes: {
                    ...
                    name: 'long-text', id: 'survey_experience_3', attributes: {
                        label: 'What kind of support or resources do you feel would enhance your involvement in swissDAO?',
                    }
                }, {
                    name: 'multiple-choice', id: 'final', attributes: {
                        label: "By clicking \"YES\" you accept that the data you gave us will be save.",
                        required: true,
                        verticalAlign: true,
                        choices: [{
                            label: "Yes", value: "Yes",
                ...
                switch (currentBlockId) {
                    case "ethereum_address":
                        if (isValidEthereumAddress(answers["ethereum_address"].value)) {
                            ...
                            setFieldValidationErr("ethereum_address", "Please enter a valid Ethereum address");
                            setIsPending(false);
