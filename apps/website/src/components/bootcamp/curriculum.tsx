const people = [
  ...
  export default function Curriculum() {
    return (
      <div className="py-16 bg-indigo-400">
        <div className="mx-auto md:w-3/4 max-w-7xl">
          <div className="bg-gray-50 rounded-3xl py-10">
            <div className="px-4 sm:px-6 lg:px-8">
              <div className="sm:flex sm:items-center">
                <div className="sm:flex-auto">
                  <h1 className="font-semibold pb-2 leading-6 text-2xl text-gray-900">Curriculum - Programme of the 12 Weeks Bootcamp</h1>
                      ...
                      <tbody className="divide-y divide-gray-800">
                        {people.map((person) => (
                          <tr key={person.name}>
                            ...
                            <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-800">{person.title}</td>
