          ...
          <div className="mx-auto max-w-2xl">
            <div className="max-w-lg">
              ...
              <h1 className="mt-6 text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                Excel in Web3 <br></br> with our Solidity course <br></br>
              </h1>
              <p className="mt-6 text-lg leading-8 text-gray-600">
                swissDAO Solidity Developer Bootcamp is a 12 week cohort program that teaches you the fundamentals to become a solidity developer.
              </p>
              <div className="mt-10 flex items-center gap-x-6">
                ...
                <a href="#" className="text-sm font-semibold leading-6 text-gray-900">
                  Check the curriculum <span aria-hidden="true">→</span>
                </a>
              </div>
            </div>
          </div>
