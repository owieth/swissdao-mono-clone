const items = [
    { id: 1, outcome: "Develop smart contracts with a proper framework and strategy" },
    { id: 2, outcome: "Optimise your smart contracts for gas usage and check for vulnerabilities" },
...
const people = [
    ...
    },
    {
      ...
      role: 'Co-Founder / CEO',
      imageUrl:
        '/images/bootcamp/javascript.png',
    },
    // More people...
  ]
...
export default function Outcome() {
    return (
        <div className="mx-auto max-w-6xl px-6 py-16">
            <div className="flex flex-col md:flex-row justify-between mx-auto max-w-6xl">
                <div className='flex flex-col'>
                    <h2 className="text-base font-semibold leading-7 text-indigo-600">In a nutshell</h2>
                    <h2 className="text-left mb-2 md:mb-8 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                    Become a <br/> Solidity Developer in weeks
                    </h2>
                    <ul
                    role="list"
                    className="text-sm leading-6 text-gray-600 sm:gap-6"
                    >
                    {includedFeatures.map((feature) => (
                        <li key={feature} className="flex gap-x-3 my-2">
                ...
                <div className='flex flex-col'>
                    <p className="mt-2 text-left leading-8 text-gray-600 max-w-md">
